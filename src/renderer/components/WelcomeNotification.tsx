                        ...
                        <div className="p-7">
                            ...
                            <div className="flex items-start justify-between mb-8">
                                <div className="flex items-center gap-4">
                                    <div className="relative">
                                        ...
                                        <div className={`relative w-14 h-14 rounded-2xl flex items-center justify-center shadow-lg bg-emerald-600 shadow-emerald-900/50`}>
                                ...
                                <button
                                    onClick={handleClose}
                                    className={`p-2.5 rounded-xl transition-all duration-300 transform hover:rotate-90 ${
                                        theme === 'dark'
                            ...
                            <div className="space-y-3.5">
                                ...
                                <div className={`relative overflow-hidden rounded-2xl p-5 border transition-all duration-300 ${
                                    theme === 'dark'
                                        ? 'bg-[#212738] border-transparent hover:border-slate-700 shadow-inner shadow-white/5'
                                    ...
                                    <div className="absolute right-[-10px] top-1/2 -translate-y-1/2 pointer-events-none">
                                        <FiInfo className={`w-32 h-32 ${theme === 'dark' ? 'text-white/[0.03]' : 'text-emerald-600/[0.04]'}`} />
                                    </div>
                                    <div className="relative z-10 flex items-start gap-4">
                                        ...
                                        <div className="flex-1 pt-0.5">
                                            ...
                                            <p className={`text-[13.5px] leading-relaxed pr-2 ${
                                ...
                                <button
                                    ...
                                    className={`group w-full flex items-center gap-4 p-4 rounded-2xl border transition-all duration-300 text-left ${
                                        theme === 'dark'
                                            ? 'bg-[#212738] border-transparent hover:border-slate-700'
                                            : 'bg-white border-gray-100 hover:border-emerald-200 shadow-[0_2px_10px_-3px_rgba(16,185,129,0.1)]'
                                    }`}
                                >
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className={`text-[14px] font-bold leading-non mt-1 transition-colors ${
                                ...
                                <button
                                    ...
                                    className={`group w-full flex items-center gap-4 p-4 rounded-2xl border transition-all duration-300 text-left ${
                                        theme === 'dark'
                                            ? 'bg-[#212738] border-transparent hover:border-slate-700'
                                            : 'bg-white border-gray-100 hover:border-emerald-200 shadow-[0_2px_10px_-3_rgba(16,185,129,0.1)]'
                                    }`}
                                >
                                    <div className={`w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0 transition-colors ${
                                        theme === 'dark' ? 'bg-[#2d374d] text-emerald-400 group-hover:bg-[#34405a]' : 'bg-emerald-600 text-white'
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className={`text-[15px] font-bold leading-none mt-1 transition-colors ${
                                            theme === 'dark' ? 'text-gray-200 group-hover:text-white' : 'text-gray-800'
                                        }`}>
                                            (+92) 3205720-774
                                        </p>
                                ...
                                <button
                                    ...
                                    className={`group w-full flex items-center gap-4 p-4 rounded-2xl border transition-all duration-300 text-left ${
                                        theme === 'dark'
                                            ? 'bg-[#212738] border-transparent hover:border-slate-700'
                                            : 'bg-white border-gray-100 hover:border-green-200 shadow-[0_2px_10px_-3px_rgba(16,185,129,0.1)]'
                                    }`}
                                >
                                    <div className={`w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0 transition-colors ${
