            ...
            <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-4 space-y-3">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full px-3 py-2 text-xs bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all resize-none"
